  ...
  izmeni(host, option, tbx) {
    ...
    switch (option) {
      case "Temperatura":
        ...
        fetch(
          "https://localhost:5001/MeteoroloskiPodatak/IzmeniTemperaturu/" +
            this.id +
            "/" +
            br,
          {
      ...
      case "Padavine":
        ...
        fetch(
          "https://localhost:5001/MeteoroloskiPodatak/IzmeniPadavine/" +
            this.id +
            "/" +
            br,
          {
      ...
      case "Suncani dani":
        ...
        fetch(
          "https://localhost:5001/MeteoroloskiPodatak/IzmeniDane/" +
            this.id +
            "/" +
            br,
          {
